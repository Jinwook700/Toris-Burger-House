...
public class PlateController : MonoBehaviour
{
    ...
    private int CalculateScore(List<int> plateCombo)
    {
        ...
        if (!hasDrinkMenu)
        {
            Tori.Instance.SetState(CharacterState.Angry, "�̷� �޴��� ���ٳ�!");
            return 0;
        }
        ...
        List<int> middleIngredients = new List<int>
    {
        ...
        if (score == 1000)
        {
            Tori.Instance.SetState(CharacterState.Happy, "���ְڴٳ�~!");
        }
        else if (potatoMissing && burntCount == 0)
        {
            Tori.Instance.SetState(CharacterState.Angry, "���ڸ� �����ϳ�!");
        }
        else if (potatoBurnt && burntCount == 0)
        {
            Tori.Instance.SetState(CharacterState.Normal, "���ڿ��� ź�����ٳ�..");
        }
        else if (!potatoBurnt && !potatoMissing && burntCount == 1)
        {
            Tori.Instance.SetState(CharacterState.Normal, "�߸԰ڴٳ�!");
        }
        else if (!potatoBurnt && !potatoMissing && burntCount == 2)
        {
            Tori.Instance.SetState(CharacterState.Normal, "�������ϴٳ�");
        }
        else if (!potatoBurnt && !potatoMissing && burntCount >= 3)
        {
            Tori.Instance.SetState(CharacterState.Angry, "�� �丮���������");
        }
        else if (potatoBurnt && burntCount >= 1)
        {
            Tori.Instance.SetState(CharacterState.Normal, "�� �丮���� �����..");
        }
        else
        {
            Tori.Instance.SetState(CharacterState.Normal, "�����޴ٳ�.");
        }
